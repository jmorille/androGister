package eu.ttbox.androgister.ui.admin.tag.holocolorpicker;
...
public class HoloColorPickerDialog extends DialogFragment implements OnColorChangedListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // .setIcon(R.drawable.alert_dialog_icon
                .setView(view) //
                .setTitle(R.string.tag_color_picker)//
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        // ((FragmentAlertDialog)getActivity()).doPositiveClick();
                        OnColorChangedListener target = (OnColorChangedListener) getTargetFragment();
