...
public class DeviceAdminActivity  extends PreferenceActivity {
    ...
    ComponentName mDeviceAdminActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceAdminActivity = new ComponentName(this, DeviceAdminActivityReceiver.class);
    }
    ...
    private boolean isActiveAdmin() {
        return mDPM.isAdminActive(mDeviceAdminActivity);
    }
    ...
    public static class AdminSampleFragment extends PreferenceFragment
        ...
        protected DeviceAdminActivity mActivity;
        protected DevicePolicyManager mDPM;
        protected ComponentName mDeviceAdminActivity;
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            mActivity = (DeviceAdminActivity) getActivity();
            mDPM = mActivity.mDPM;
            mDeviceAdminActivity = mActivity.mDeviceAdminActivity;
    ...
    public static class GeneralFragment extends AdminSampleFragment
        ...
        public void onResume() {
            ...
            if (mAdminActive) {
                mDPM.setCameraDisabled(mDeviceAdminActivity, mDisableCameraCheckbox.isChecked());
 //TODO API 17    mDPM.setKeyguardDisabledFeatures(mDeviceAdminActivity, createKeyguardDisabledFlag());
                Log.e(TAG, "setKeyguardDisabledFeatures : NOT BEFORE API 17");
                reloadSummaries();
            }
        }
            ...
            if (preference == mEnableCheckbox) {
                if (value != mAdminActive) {
                    if (value) {
                        ...
                        intent.putExtra(DevicePolicyManager.EXTRA_DEVICE_ADMIN, mDeviceAdminActivity);
                        ...
                        mDPM.removeActiveAdmin(mDeviceAdminActivity);
                        enableDeviceCapabilitiesArea(false);
                        mAdminActive = false;
                    }
                }
            } else if (preference == mDisableCameraCheckbox) {
                mDPM.setCameraDisabled(mDeviceAdminActivity, value);
                reloadSummaries();
 ...
 //TODO API 17                mDPM.setKeyguardDisabledFeatures(mDeviceAdminActivity, createKeyguardDisabledFlag());
        ...
        protected void reloadSummaries() {
            ...
            String cameraSummary = getString(mDPM.getCameraDisabled(mDeviceAdminActivity)
                    ? R.string.camera_disabled : R.string.camera_enabled);
            mDisableCameraCheckbox.setSummary(cameraSummary);

            int disabled = 0;
  //TODO API 17           int disabled = mDPM.getKeyguardDisabledFeatures(mDeviceAdminActivity);
    ...
    public static class QualityFragment extends AdminSampleFragment
        ...
        protected void reloadSummaries() {
            ...
            int local, global;
            local = mDPM.getPasswordQuality(mDeviceAdminActivity);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mPasswordQuality) {
                mDPM.setPasswordQuality(mDeviceAdminActivity, value);
            } else if (preference == mMinLength) {
                mDPM.setPasswordMinimumLength(mDeviceAdminActivity, value);
            } else if (preference == mMinLetters) {
                mDPM.setPasswordMinimumLetters(mDeviceAdminActivity, value);
            } else if (preference == mMinNumeric) {
                mDPM.setPasswordMinimumNumeric(mDeviceAdminActivity, value);
            } else if (preference == mMinLowerCase) {
                mDPM.setPasswordMinimumLowerCase(mDeviceAdminActivity, value);
            } else if (preference == mMinUpperCase) {
                mDPM.setPasswordMinimumUpperCase(mDeviceAdminActivity, value);
            } else if (preference == mMinSymbols) {
                mDPM.setPasswordMinimumSymbols(mDeviceAdminActivity, value);
            } else if (preference == mMinNonLetter) {
                mDPM.setPasswordMinimumNonLetter(mDeviceAdminActivity, value);
            }
            reloadSummaries();
            return true;
        }
    ...
    public static class ExpirationFragment extends AdminSampleFragment
        ...
        protected void reloadSummaries() {
            ...
            int local, global;
            local = mDPM.getPasswordHistoryLength(mDeviceAdminActivity);
            global = mDPM.getPasswordHistoryLength(null);
            mHistory.setSummary(localGlobalSummary(local, global));

            long localLong, globalLong;
            localLong = mDPM.getPasswordExpirationTimeout(mDeviceAdminActivity);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mHistory) {
                mDPM.setPasswordHistoryLength(mDeviceAdminActivity, value);
            } else if (preference == mExpirationTimeout) {
                mDPM.setPasswordExpirationTimeout(mDeviceAdminActivity, value * MS_PER_MINUTE);
            }
            reloadSummaries();
            return true;
        }
        ...
        private String getExpirationStatus() {
            ...
            long localExpiration = mDPM.getPasswordExpiration(mDeviceAdminActivity);
    ...
    public static class LockWipeFragment extends AdminSampleFragment
        ...
        protected void reloadSummaries() {
            ...
            long localLong, globalLong;
            localLong = mDPM.getMaximumTimeToLock(mDeviceAdminActivity);
            globalLong = mDPM.getMaximumTimeToLock(null);
            mMaxTimeScreenLock.setSummary(localGlobalSummary(
                    localLong / MS_PER_MINUTE, globalLong / MS_PER_MINUTE));

            int local, global;
            local = mDPM.getMaximumFailedPasswordsForWipe(mDeviceAdminActivity);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mMaxTimeScreenLock) {
                mDPM.setMaximumTimeToLock(mDeviceAdminActivity, value * MS_PER_MINUTE);
            } else if (preference == mMaxFailures) {
                if (alertIfMonkey(mActivity, R.string.monkey_wipe_data)) {
                    return true;
                }
                mDPM.setMaximumFailedPasswordsForWipe(mDeviceAdminActivity, value);
            }
            reloadSummaries();
            return true;
        }
        ...
        private void promptForRealDeviceWipe(final boolean wipeAllData) {
            final DeviceAdminActivity activity = mActivity;
    ...
    public static class EncryptionFragment extends AdminSampleFragment
        ...
        public void onResume() {
            ...
            mRequireEncryption.setChecked(mDPM.getStorageEncryption(mDeviceAdminActivity));
        }
        ...
        protected void reloadSummaries() {
            ...
            local = mDPM.getStorageEncryption(mDeviceAdminActivity);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference == mRequireEncryption) {
                ...
                mDPM.setStorageEncryption(mDeviceAdminActivity, newActive);
                reloadSummaries();
                return true;
            }
            return true;
    ...
    public static class DeviceAdminActivityReceiver extends DeviceAdminReceiver {
        ...
        public void onPasswordExpiring(Context context, Intent intent) {
            ...
            long expr = dpm.getPasswordExpiration(
                    new ComponentName(context, DeviceAdminActivityReceiver.class));
