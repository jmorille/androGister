...
public class ProductDbBootstrap {
    ...
    public long addProduct(String name, String tag, String price) {
        ...
        initialValues.put(ProductDatabase.ProductColumns.KEY_NAME, name);
        initialValues.put(ProductDatabase.ProductColumns.KEY_TAG, tag);
        initialValues.put(ProductDatabase.ProductColumns.KEY_PRICEHT, price);
        return mDatabase.insert(ProductDatabase.TABLE_PRODUCT_FTS, null, initialValues);
    }
