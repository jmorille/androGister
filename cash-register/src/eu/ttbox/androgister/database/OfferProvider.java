...
public class OfferProvider extends ContentProvider {
    ...
    private Cursor getSuggestions(String query) {
        ...
        String[] columns = new String[] { OfferDatabase.OfferColumns.KEY_ID, OfferDatabase.OfferColumns.KEY_NAME, OfferDatabase.OfferColumns.KEY_DESCRIPTION,
        /*
        ...
        return offerDatabase.getOfferMatches(query, columns, null);
    }

    private Cursor search(String[] _projection, String _selection, String[] _selectionArgs, String _sortOrder) {
        String[] projection = _projection == null ? OfferDatabase.OfferColumns.ALL_KEYS : _projection;
        ...
        return offerDatabase.queryOffer(selection, selectionArgs, projection, sortOrder);
    }

    // private Cursor search(String query) {
    // query = query.toLowerCase();
    // String[] columns = new String[] { OfferDatabase.OfferColumns.KEY_ID,
    // OfferDatabase.OfferColumns.KEY_NAME,
    // OfferDatabase.OfferColumns.KEY_DESCRIPTION };
    // return offerDatabase.getOfferMatches(query, columns);
    // }

    private Cursor getOffer(Uri uri) {
        String rowId = uri.getLastPathSegment();
        String[] columns = new String[] { OfferDatabase.OfferColumns.KEY_NAME, OfferDatabase.OfferColumns.KEY_DESCRIPTION };
        return offerDatabase.getOffer(rowId, columns);
    }

    private Cursor refreshShortcut(Uri uri) {
        String rowId = uri.getLastPathSegment();
        String[] columns = new String[] { OfferDatabase.OfferColumns.KEY_ID, OfferDatabase.OfferColumns.KEY_NAME, OfferDatabase.OfferColumns.KEY_DESCRIPTION, SearchManager.SUGGEST_COLUMN_SHORTCUT_ID,
                SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID };
    ...
    public String getType(Uri uri) {
        switch (sURIMatcher.match(uri)) {
        case SEARCH_OFFERS:
            return OFFERS_LIST_MIME_TYPE;
        case GET_OFFER:
            return OFFER_MIME_TYPE;
        case SEARCH_SUGGEST:
