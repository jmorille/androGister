...
public class OrderItemDatabase {
	...
	public static class Column {
		...
		public static final String[] ALL_KEYS = new String[] {KEY_ID, KEY_NAME, KEY_PRODUCT_ID, KEY_EAN, KEY_PRICE_SUM_HT, KEY_PRICE_UNIT_HT};

	}

	private final OrderItemOpenHelper mDatabaseOpenHelper;
	...
	public OrderItemDatabase(Context context) {
		mDatabaseOpenHelper = new OrderItemOpenHelper(context);
	}
	...
	public Cursor query(String selection, String[] selectionArgs,
		...
		builder.setTables(OrderItemOpenHelper.FTS_VIRTUAL_TABLE);
