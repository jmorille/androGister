...
//        KEY_PAYMENT_MODE, KEY_PERS_ID, KEY_PERS_MATRICULE, KEY_PERS_FIRSTNAME, KEY_PERS_LASTNAME 
        public static final String[] ALL_KEYS = new String[] { KEY_ID, KEY_ORDER_NUMBER, KEY_ORDER_UUID, KEY_STATUS, KEY_ORDER_DATE, KEY_PRICE_SUM_HT,   KEY_PAYMENT_MODE, KEY_PERS_ID, KEY_PERS_MATRICULE, KEY_PERS_FIRSTNAME, KEY_PERS_LASTNAME };
        ...
        synchronized (lockInsertOrder) {
            ...
            try {
                try {
                    ...
                    int updatedRow = db.update(OrderDatabase.ORDER_ITEM_TABLE, values, whereClause, new String[] { orderIdString });
                    if (updatedRow != 1) {
