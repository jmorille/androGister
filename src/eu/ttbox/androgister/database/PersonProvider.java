...
public class PersonProvider extends ContentProvider {
	...
	private Cursor getSuggestions(String query) {
		...
		String[] columns = new String[] { PersonDatabase.PersonColumns.KEY_ID, PersonDatabase.PersonColumns.KEY_LASTNAME, 
	...
	private Cursor getPerson(Uri uri) {
		...
		String[] columns = new String[] { PersonDatabase.PersonColumns.KEY_LASTNAME, PersonDatabase.PersonColumns.KEY_FIRSTNAME };
